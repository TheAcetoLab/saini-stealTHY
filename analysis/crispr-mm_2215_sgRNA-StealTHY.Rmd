...
```{r da-positive-controls-genes-dotplot, fig.width=2.37, fig.asp=0.4}
...
```{r non-expressed-combined-hits-data-4t1}
use_annot <- colData(se)
...
```{r non-expressed-combined-hits-data-mvt1}
use_annot <- colData(se)
...
```{r non-expressed-combined-hits-data-py2t}
use_annot <- colData(se)
