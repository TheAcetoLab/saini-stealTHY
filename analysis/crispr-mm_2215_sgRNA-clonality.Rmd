...
data_array <- c(
  ...
  "dCas9+Puro","dCas4T1Repl1_NSGLung","NSG Lung mets","NSG","Lung mets",
  "dCas9+Puro","dCas4T1Repl2_NSGLung","NSG Lung mets","NSG","Lung mets",
  "dCas9+Puro","dCas4T1Repl3_NSGLung","NSG Lung mets","NSG","Lung mets",
  "dCas9+Puro","dCas4T1Repl4_NSGLung","NSG Lung mets","NSG","Lung mets",
  "dCas9+Puro","dCas4T1Repl5_NSGLung","NSG Lung mets","NSG","Lung mets",
...
# use_sample_groups[!use_sample_groups$sample_alias %in% colnames(se),]
...
chunk_data %>% filter(sample_alias == 'Replacement_6bis')
chunk_data['Replacement_6bis',]
...
#   'dCas4T1Repl3_NSGTum',
#   'dCas4T1Repl4_NSGTum',
#   'dCas4T1Repl1_NSGLung',
#   'dCas4T1Repl3_NSGLung',
#   'dCas4T1Repl4_NSGLung',
#   'dCas4T1Repl5_NSGLung'
# )
