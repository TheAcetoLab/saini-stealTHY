...
```{r gseaplot2-custom-labels-individual-plot-sf7L, fig.width=7.2, fig.asp = 0.5}
...
```{r gseaplot2-custom-labels-individual-plot-sf7Mtop, fig.width=7.2, fig.asp = 0.5}
...
```{r gseaplot2-custom-labels-individual-plot-sf7p, fig.width=7.2, fig.asp = 0.5}
...
```{r gseaplot2-custom-labels-individual-plot-sf7Uleft, fig.width=7.2, fig.asp = 0.5}
i <- "InVivo_AMHR2_KO + AMHR2_KO_culture--over--InVivo_Control_sgRNA + AMHR2_Control_culture"
...
```{r gseaplot2-custom-labels-individual-plot-sf7Uright, fig.width=7.2, fig.asp = 0.5}
i <- "AMHR2_KO_noTGFbeta--over--AMHR2_Control_culture"
use_gsets <- c('STAT1 target genes and interactors')
...
## All GSEA plots
```{r gseaplot2-custom-labels-individual-plot, fig.width=7.2, fig.asp = 0.5, eval = FALSE}
