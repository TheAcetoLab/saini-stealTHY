...
comp_list_muller <- list(
  `Comparison 1: CMT167 Syngeneic Thy` = list(
    `CMT167 Syngeneic Thy 1` = c('C167_StealTHY_Tum_1',	'C167_StealTHY_Met_1'),
    `CMT167 Syngeneic Thy 3` = c('C167_StealTHY_Tum_3',	'C167_StealTHY_Met_3'),
    `CMT167 Syngeneic Thy 4` = c('C167_StealTHY_Tum_4',	'C167_StealTHY_Met_4'),
    `CMT167 Syngeneic Thy 5` = c('C167_StealTHY_Tum_5',	'C167_StealTHY_Met_5')
  ),
  `Comparison 2: LLC1 Syngeneic Thy` = list( 
   `LLC1 Syngeneic Thy 1` =  c('LLC1_StealTHY_Tum_1',	'LLC1_StealTHY_Met_1'),
   `LLC1 Syngeneic Thy 2` =  c('LLC1_StealTHY_Tum_2',	'LLC1_StealTHY_Met_2'),
   `LLC1 Syngeneic Thy 3` =  c('LLC1_StealTHY_Tum_3',	'LLC1_StealTHY_Met_3'),
   `LLC1 Syngeneic Thy 4` =  c('LLC1_StealTHY_Tum_4',	'LLC1_StealTHY_Met_4'),
   `LLC1 Syngeneic Thy 5` =  c('LLC1_StealTHY_Tum_5',	'LLC1_StealTHY_Met_5')
  ),
  `Comparison 3: CT26 Syngeneic Thy` = list( 
    `CT26 Syngeneic Thy 1` = c('ColoCT26_StealTHY_Tum_1',	'ColoCT26_StealTHY_Met_1'),
    `CT26 Syngeneic Thy 2` = c('ColoCT26_StealTHY_Tum_2',	'ColoCT26_StealTHY_Met_2'),
    `CT26 Syngeneic Thy 3` = c('ColoCT26_StealTHY_Tum_3',	'Replacement_1'),
    `CT26 Syngeneic Thy 4` = c('Replacement_2',	'Replacement_3'),
    `CT26 Syngeneic Thy 5` = c('Replacement_4',	'Replacement_4bis')
  ),
  ...
  `Comparison 10: CMT167 NSG Thy1` = list(
    `CMT167 NSG Thy1 1` = c('Replacement_9',	'Replacement_1bis'),
    `CMT167 NSG Thy1 2` = c('Replacement_5',	'Replacement_6')
  ),
  `Comparison 11: LLC1 NSG Thy1` = list(
    `LLC1 NSG Thy1 1` = c('Replacement_2bis',	'Replacement_3bis'),
